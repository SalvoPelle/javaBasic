package exercise.javabasics._10_rifatto;
...
public class Main {
    ...
    private static void exercise2() {
        ...
        if (shoeType.equals("fancy") && age > 18 && eurosInPocket >= eurosForEntry) {//CORREZIONE: invece di usare == ho usato il metodo equals.
    ...
    private static void exercise3() {
        ...
        if (ourTestScore >= 9) {// 90%+
            isTestRetry = !isTestRetry;// don't retry the test
            System.out.println("A");
            System.out.println("Good job");
        } else if (ourTestScore >= 8) {//80%+
            isTestRetry = !isTestRetry;// don't retry the test
            System.out.println("B");
            System.out.println("Good job");
        } else if (ourTestScore >= 7) {// 70%+
            isTestRetry = !isTestRetry;// don't retry the test--  PER LA CORREZIONE. isTestRetry è IMPOSTATO COME VERO. COME NEGLI ALTRI IF, CON IL VOTO C QUESTA RIGA DARA' COME RISULTATO FALSO
            System.out.println("C");                            // QUINDI SARA' L'ULTIMO VOTO VALIDO PER NON RIPETERE IL TEST. GLI ALTRI DUE SOTTO INVECE AVRANNO isTestRetry = TRUE E I VOTI
            System.out.println("Good job");                     // ASSEGNATI IN BASE ALLA PERCENTUALE OTTENUTA.
    ...
    private static void exercise4Bonus() {
        ...
        if (carIsDrivingFromRightToLeft ^ carIsDrivingFromLeftToRight){
            ...
            System.out.println("CRASH! or not cars");
        }
    }
}
