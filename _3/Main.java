package exercise.javabasics._3;
...
public class Main {
    ...
    private static void exercise2() {
        ...
        System.out.println("Price of lunch= ");
    ...
    private static void exercise3() {
        ...
        // Write your code here
        int myAge = 34;
        boolean hadILunch = true;
        double priceOfLunch = 3.54;

        System.out.println("My age is= ");
        System.out.println(myAge);
        System.out.println("Had I Lunch? ");
        System.out.println(hadILunch);
        System.out.println("Price of lunch= ");
        System.out.println(priceOfLunch);
    }
}
