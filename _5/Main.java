package exercise.javabasics._5;
...
public class Main {
    ...
    private static void exercise1() {
        ...
        System.out.println("Random number plus one is = " + randomNumber);

        randomNumber = randomNumber - 1;
        System.out.println("Random number minus one is = " + randomNumber);
    }
    ...
    private static void exercise2() {
        System.out.println("\nExercise 2:");
        // Write your code here
        double multiplesNumber = 5.50;
        multiplesNumber = multiplesNumber * 2;
        System.out.println("The double number times by two is = " + multiplesNumber);

        double dividedNumber = 5.50;
        dividedNumber = dividedNumber / 2;
        System.out.println("The double number divided by two is = " + dividedNumber);
    }
    ...
    private static void exercise4Bonus() {
        ...
        age ++;
        age ++;
        System.out.println("The age increase is = " + age);
