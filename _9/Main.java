...
public class Main {
    ...
    private static void exercise3() {
        System.out.println("\nExercise 3:");
        double ourDouble = 1.3;// 3.5
        //Write your code here
        if (ourDouble > 2.5) { // first condition
            System.out.println(ourDouble + "Greater than 2.5");
        } else if (ourDouble < 2.5) {// second condition
            ourDouble++;// increase by 1
            if (ourDouble < 2.5) {// third condition if the number still less than 2.5 after increase
                System.out.println("Still less than 2.5");
            } else {// condition if, after increase, is greater than
